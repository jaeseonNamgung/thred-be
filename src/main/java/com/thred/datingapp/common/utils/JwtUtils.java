...
public class JwtUtils {
    ...
    public Long getSocialId(String token){
        return Jwts.parser().verifyWith(secretKey).build().parseSignedClaims(token).getPayload().get(SOCIAL_ID, Long.class);
    }
    ...
    public String createJwt(String category,Long socialId,Long userId,String role, Long expired){
        return Jwts.builder()
