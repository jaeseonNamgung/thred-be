...
import com.thred.datingapp.user.service.BlockService;
...
public class MemberController {
  ...
  @PostMapping("/block")
  public ApiDataResponse<ProcessingResultResponse> setBlockNumber(@RequestBody @Valid BlockNumbersRequest request, @Login Long userId) {
    ...
    blockService.setBlockNumber(userId, request.numbers());
    return ApiDataResponse.ok(ProcessingResultResponse.from(true));
  }
  ...
  public ApiDataResponse<BlockNumbersResponse> getBlockNumber(@Login Long userId) {
    ...
    return ApiDataResponse.ok(blockService.getBlockNumber(userId));
  }
  ...
  public ApiDataResponse<JudgmentResponse> getJoinReviewResponse(@Login Long userId) {
    ...
    return ApiDataResponse.ok(JudgmentResponse.of(review.getReviewStatus().name(), review.getReason(), joinDetails));
  }

  @GetMapping("/{userId}/details")
  public ApiDataResponse<UserDetailsResponse> getUserProfile(@PathVariable("userId") Long userId, @Login Long loginId) {
  ...
  @PostMapping("/details")
  public ApiDataResponse<JoinTotalDetails> editMainDetails(@RequestBody @Valid EditMainDetailsRequest request, @Login Long loginId) {
    ...
    userService.updateUserAndDetails(loginId, request.questionChange(), request.introduceChange(), request.user(), request.details());
  ...
  @PostMapping("/number")
  public ApiDataResponse<ProcessingResultResponse> editUserNumber(@Login Long loginId, @RequestBody @Valid ChangePhoneNumberRequest request) {
  ...
  @PostMapping("/address")
  public ApiDataResponse<ProcessingResultResponse> editAddress(@Login Long loginId, @RequestBody @Valid ChangeAddressRequest request) {
