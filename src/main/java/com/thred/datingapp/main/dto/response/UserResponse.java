...
public record UserResponse(Long userId, String username, String city, String province, int age, String role, String introduce, String question1,
  ...
  public static UserResponse of(User user, Question question) {
    ...
    return new UserResponse(user.getId(), user.getUsername(), city, province, user.getAge(), user.getRole().toString(), user.getIntroduce(),
  ...
  public static UserResponse of(EditTotalRequest request, User user) {
    ...
    String city = user.getAddress().getCity();
    String province = user.getAddress().getProvince();
    return new UserResponse(user.getId(), user.getUsername(), city, province, user.getAge(), user.getRole().toString(), editUser.introduce(),
  ...
  public static UserResponse of(EditTotalRequest request, User user, String introduce) {
    ...
    String city = user.getAddress().getCity();
    String province = user.getAddress().getProvince();
    return new UserResponse(user.getId(), user.getUsername(), city, province, user.getAge(), user.getRole().toString(), introduce,
                            editUser.question1(), editUser.question2(), editUser.question3());
  }
